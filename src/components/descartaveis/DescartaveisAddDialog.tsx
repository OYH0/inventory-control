...
interface DescartaveisAddDialogProps {
  newItem: NewItem;
    ...
    <DialogContent className="sm:max-w-[600px] max-h-[85vh] overflow-hidden flex flex-col" aria-describedby="dialog-description">
      <DialogHeader className="flex-shrink-0">
        ...
        <DialogDescription id="dialog-description">
          Preencha os dados do novo item descartável para adicionar ao estoque
        </DialogDescription>
      </DialogHeader>
      <div className="space-y-4 overflow-y-auto pr-2 flex-1" style={{ maxHeight: 'calc(85vh - 140px)' }}>
        <div className="space-y-2">
          ...
          <Input
            id="nome"
            placeholder="Ex: Copo plástico, Prato descartável, Guardanapo..."
            value={newItem.nome}
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs">
                      <p>Quantidade estimada que você usa por ano. Essencial para classificação ABC e cálculo de EOQ.</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <Input
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs">
                      <p>Custo fixo para fazer um pedido (frete, processamento, etc). Padrão sugerido: R$ 60,00</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <Input
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs">
                      <p>Percentual do custo para manter produto em estoque (espaço, etc). Padrão: 18%</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <Input
