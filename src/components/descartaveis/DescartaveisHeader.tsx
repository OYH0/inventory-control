  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-foreground">Descartáveis</h2>
          <p className="text-sm md:text-base text-muted-foreground">Produtos descartáveis e embalagens</p>
        </div>
      </div>
