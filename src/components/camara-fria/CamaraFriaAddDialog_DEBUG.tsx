...
export function CamaraFriaAddDialog({
  ...
  const handleAddItem = () => {
    ...
    console.log('Nome preenchido?', newItem.nome.trim() !== '');
    console.log('Categoria selecionada?', newItem.categoria !== '');
    ...
    console.log('Chamando onAddNewItem...');
    ...
    try {
      ...
      onAddNewItem();
      console.log('onAddNewItem chamado com sucesso');
    } catch (error) {
    ...
    <DialogContent>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-3 rounded text-xs">
          ...
          <p>Nome válido: {newItem.nome.trim() !== '' ? '✅' : '❌'}</p>
          <p>Categoria válida: {newItem.categoria !== '' ? '✅' : '❌'}</p>
