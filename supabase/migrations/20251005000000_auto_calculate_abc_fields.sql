-- =====================================================
-- AUTO-CALCULATE ABC FIELDS ON INSERT/UPDATE
-- Calcula automaticamente annual_consumption_value quando
-- unit_cost ou annual_demand são preenchidos
-- =====================================================
...
COMMENT ON FUNCTION calculate_annual_consumption_value() IS 
...
BEGIN
  ...
  RAISE NOTICE '  ✓ Auto-cálculo de annual_consumption_value em todas as tabelas';
  RAISE NOTICE '';
  RAISE NOTICE 'Produtos existentes atualizados automaticamente.';
  RAISE NOTICE '';
  RAISE NOTICE 'Agora quando você adicionar/editar produtos com unit_cost e annual_demand,';
  RAISE NOTICE 'o annual_consumption_value será calculado automaticamente!';
  RAISE NOTICE '';
END $$;
